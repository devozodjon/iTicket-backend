...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "phone_number",
                    models.CharField(
                        blank=True, db_index=True, max_length=17, null=True, unique=True
                    ),
                ),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "visit_location",
                    models.JSONField(
                        blank=True, help_text="Geographic location data", null=True
                    ),
                ),
                (
                    "language",
                ...
                (
                    "is_auth_password",
                    models.BooleanField(
                        default=False, verbose_name="Biometric Authentication Enabled"
                    ),
                ),
                (
                    "device_token",
        ...
        migrations.AddIndex(
            model_name="device",
            index=models.Index(
                fields=["device_id", "device_type"], name="device_id_type_idx"
            ),
        ),
        migrations.AddIndex(
            model_name="device",
